...
export const GET_PRODUCTS_LOAD = 'GET_PRODUCTS_BEGIN';
export const GET_PRODUCTS_LOAD_SUCCESS = 'GET_PRODUCTS_SUCCESS';
export const GET_PRODUCTS_ERROR = 'GET_PRODUCTS_ERROR';
export const GET_SINGLE_PRODUCT_lOAD = 'GET_SINGLE_PRODUCT_BEGIN';
